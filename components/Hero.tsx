...
const Hero: React.FC<HeroProps> = ({ data }) => {
  return (
    <section id="about" className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden min-h-screen">
      <div className="absolute top-20 right-0 -mr-20 w-96 h-96 bg-neo-muted/30 rounded-full blur-3xl"></div>
      <div className="absolute bottom-20 left-0 -ml-20 w-72 h-72 bg-neo-secondary/40 rounded-full blur-3xl"></div>
